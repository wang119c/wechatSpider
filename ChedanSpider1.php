...
//    'Referer' => 'https://querylist.cc/',
    ...
    {
        while (true) {
            $list = $this->getQueryData("http://apis.yyuehd.com/api/v2/article/load/list?pageSize=15&category=VIDEO&userId=c4e585d8-4752-4e6a-9243-cc0111b9e5fd&net=WIFI&androidId=7078044313178878");
            // var_dump(1323123);
